...
scene.background = new THREE.Color('#40339e')
...
/// SCENE LIGHTS
const ambient = new THREE.AmbientLight(0x8181df, 0.53)
scene.add(ambient)

const sunLight = new THREE.DirectionalLight(0x331fc7, 1.3962)
sunLight.position.set(-100,44,13);
...
loader.load('models/gltf/house3.glb', function (gltf) {
